...
pl.pp <- p + ggplot2::geom_point(data = crab2, ggplot2::aes(x =RW , y = BD, group=Type,shape = Type, color=Type), size = I(3)  ) +  ggplot2::scale_shape_manual(name = "Class", labels = levels(crab2$Type),values = c(19, 18, 15, 17)) + ggplot2::scale_colour_brewer(type="qual",palette="Dark2") + ggplot2::theme_bw() +theme(legend.position = "bottom", legend.text = element_text(size = 6)) +ggplot2::scale_colour_manual(name = "Class",
 ...
 pl.rpart <- p2 + ggplot2::geom_point(data = crab2, ggplot2::aes(x =RW , y = BD, group=Type,shape = Type, color=Type), size = I(3)  ) +  ggplot2::scale_shape_manual(name = "Class", labels = levels(crab2$Type),values = c(19, 18, 15, 17)) + ggplot2::scale_colour_manual(name = "Class",
                      labels = levels(crab2$Type),
                      values =  c("#1B9E77" ,"#D95F02" ,"#7570B3" ,"#E7298A")) + theme(legend.position = "bottom",legend.text = element_text(size = 6))
