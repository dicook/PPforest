...
```{r, v1,fig.show='hold', fig.width = 6, fig.height = 6, echo=FALSE, cache=TRUE}
load("../data/crab.rda")
...
```{r, v2,fig.show='hold',fig.width = 7 ,fig.height = 7, echo=FALSE, message=FALSE,cache=TRUE}
# library(ggplot2)
# library(RColorBrewer)
...
```{r,v3, fig.show='hold',fig.width = 7, fig.height = 4, echo=FALSE, message=FALSE,cache=TRUE, warning=FALSE,eval=FALSE}
...
```{r, v4, fig.show='hold',fig.width = 7, fig.height = 4, echo=FALSE, message=FALSE,cache=TRUE}
# library(rpart.plot)
# library(gridExtra)
# library(ggplot2)
# 
...
```{r,v10,fig.width = 4 ,fig.height = 3,echo=FALSE,cache=TRUE}
...
```{r,v11,fig.show='hold',fig.width = 7 ,fig.height = 4,cache=TRUE}
...
```{r,v12,fig.show='hold',fig.width = 6 ,fig.height = 6,cache=TRUE}
...
```{r,v13, fig.show='hold',fig.width = 4 ,fig.height = 3,cahce=TRUE}
...
```{r, v14, fig.show='hold',fig.width = 6 ,fig.height = 4,cache=TRUE}
...
```{r, v15, fig.show='hold',fig.width = 7 ,fig.height = 4, message=FALSE,cache=TRUE}
# library(ggplot2)
# load("../data/NCI60.rda")
...
```{r, v16, fig.show='hold', fig.width = 6, fig.height = 6, echo=FALSE,cache=TRUE}
# ggpairs(NCI60, 
#     columns= 27:31,
#     colour='Type',
#     lower=list(continuous='points'), 
...
```{r, v17, fig.show='hold', fig.width = 10, fig.height = 5, echo=FALSE,cache=TRUE}
...
```{r, v18, fig.show='hold',fig.width = 7 ,fig.height = 4, message=FALSE,cache=TRUE}
# library(ggplot2)
...
```{r,v21,fig.show='hold',fig.width = 5 ,fig.height = 4,echo=FALSE,cache=TRUE}
#PPforest::pproxy_plot( pprf.nci60, type="heat" )
```



```{r,v22, fig.show='hold',fig.width = 5 ,fig.height = 4,echo=FALSE,cache=TRUE}
...
```{r,v23,fig.show='hold',fig.width = 6 ,fig.height = 6,echo=FALSE,cache=TRUE}
...
```{r,v24, fig.show='hold',fig.width = 6 ,fig.height = 4,cache=TRUE}
